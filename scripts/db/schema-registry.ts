...
export const UNMANAGED_INVENTORY: readonly UnmanagedEntry[] = [
  // ---- Payments / credits / subscriptions (dropping any = financial incident) ----
  {
    ...
    reason: "migrations/0115_runtime_schema_convergence.sql",
    futureDisposition: "keep numbered-migration-managed",
    evidenceSource: "migration 0115 (runtime-schema convergence authority)",
  },
  {
    schema: "public",
  ...
  {
    schema: "public",
    name: "estimate_credit_reservations",
    objectType: "table",
    class: "numbered_migration",
    purpose: "durable exactly-once AI estimate credit reservation and compensation ledger",
    active: true,
    owningSubsystem: "ai-estimate",
    reason: "migrations/0115_runtime_schema_convergence.sql",
    futureDisposition: "keep numbered-migration-managed",
  ...
  },
  {
    ...
    reason: "no current source DDL or references; retained as protected legacy inventory pending data inspection",
    futureDisposition: "preserve if present; inspect rows/dependencies before adoption or owner-approved retirement",
    evidenceSource: `${INSPECTION}; source search 2026-08-30 found no current reader, writer, or DDL`,
  },
  {
    schema: "public",
  ...
  // ---- Auth / sessions (dropping = lockout / broken login lockouts) ----
  {
    ...
    futureDisposition: "keep numbered-migration-managed; runtime auto-create remains disabled",
    evidenceSource: "migration 0119 (connect-pg-simple schema authority)",
  },
  {
    schema: "public",
    name: "public_rate_limit_buckets",
    objectType: "table",
    class: "numbered_migration",
    purpose: "fleet-wide PII-free rate limiting for public MintVault routes",
    active: true,
    owningSubsystem: "auth/public-abuse",
    reason: "migrations/0121_main_runtime_role_authority.sql",
    futureDisposition: "keep main-runtime and Partner rate-limit storage physically separate",
    evidenceSource: "migration 0121 (main runtime role authority)",
  },
  {
    schema: "public",
    name: "object_write_operations",
    objectType: "table",
    class: "numbered_migration",
    purpose: "durable intent, lease, verification, publication and reconciliation state for object-store writes",
    active: true,
    owningSubsystem: "object-storage/reconciliation",
    reason: "migrations/0122_object_write_intent_reconciliation.sql",
    futureDisposition: "keep numbered-migration-managed; never replace with runtime DDL",
    evidenceSource: "migration 0122 (object-write intent authority)",
  },
  {
    schema: "public",
    name: "object_write_items",
    objectType: "table",
    class: "numbered_migration",
    purpose: "immutable expected object manifests, observed byte verification and safe abandoned-R2 cleanup",
    active: true,
    owningSubsystem: "object-storage/reconciliation",
    reason: "migrations/0122_object_write_intent_reconciliation.sql",
    futureDisposition: "keep numbered-migration-managed; no cascading or runtime-created replacement",
    evidenceSource: "migration 0122 (object-write item authority)",
  },
  {
    schema: "public",
    name: "sessions",

<!--
Template: protected systems reference. Not per-task — keep ONE live copy at
.claude/controlled-code-lead/protected-systems.md and update it when a new
protected system is identified. Stage 0 baselines check the live copy, not
this template.
-->

# Protected systems — MintVault

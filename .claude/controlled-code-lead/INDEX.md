...
| partner-final-rc-reconciliation         | Terra M-1 reconciliation + FINAL RC freeze           | Stage 7 COMPLETE — FINAL RC frozen, local + unpushed | `codex/partner-pilot-pass2`                     | `e6fd6c5f`  | (final RC commit) | none in code; RC-F1 stale prod record + RC-F2 RC never pushed are process/record HIGHs | owner decision: push RC + PR, then production migration/deploy plan | `tasks/partner-final-rc-reconciliation/`         |
| scanner-sol-implementation-20260814     | Scanner / Partner Mac Station production implementation | WP9 hostile CLEAN; WP10 reconciliation in progress | `codex/scanner-sol-implementation-20260814` | `d44a2c53` | `24739d90` | R-3 Apple authority external; final Partner wire extensions/reconciliation in progress | reconcile exact frozen Partner RC and run both release suites | `tasks/scanner-sol-implementation-20260814/` |

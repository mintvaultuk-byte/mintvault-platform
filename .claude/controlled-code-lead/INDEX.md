...
| canonical-lineage-final-freeze-20260819 | Canonical Partner/Scanner reconciliation and freeze   | Stage 6 regression; final postflight pending         | `codex/mintvault-final-engineering-os-reconciliation` | `d11579f1` | `12c9a641` | none in source; live release/migration remain owner-authorised | complete clean-tree postflight + final refetch/freeze check | `tasks/canonical-lineage-final-freeze-20260819/` |

...
| mintvault-public-shop-map                | Phase 24 public shop map/list                             | local proof complete                             | `codex/mintvault-final-product-integration` | `c2af48db` | pending commit | none                                                                   | continue remaining final product phases                  | `tasks/mintvault-public-shop-map/`                |

...
**Authority:** the owner explicitly authorised GB-04B closeout, a dedicated read-only MCP identity/transport, a genuine review engine, privacy-safe public authority, conversion instrumentation and integration into the existing Growth Command. The later Infrastructure Control / Cost / GBP addendum additionally authorises canonical GBP presentation, provider-read investigation, manual recommendation-only infrastructure/cost/readiness/incident/velocity contracts, and a future guarded-scaling design. This authorises local code, tests, additive migration authoring and documentation within those exact boundaries. It does **not** authorise applying a migration, writing a secret, pushing/merging, changing a provider account, mutating Fly/Neon/budget/capacity, or deploying before the separate release gates.

...
30 affected/protected files and 780 assertions green; pure repeated CSS-viewport
...
release-gate browser defects found after the first freeze and the delete-gate
MEDIUM found in first hostile review now have direct mounted/source regressions
and narrow presentation-only repairs. Final exact-SHA external gates remain pending.

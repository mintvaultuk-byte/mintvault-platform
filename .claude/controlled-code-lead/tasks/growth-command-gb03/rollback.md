...
- Database rollback (only if `0095` has been separately approved and applied): use `migrations/rollback-0095-growth-partner-applications.sql` after retaining/exporting lead records required by the approved privacy policy; do not delete live lead data casually.

-- 0103 — Partner Google Business Profile presence (OPTIONAL, PARTNER scope).
--
...
DO $$ BEGIN
  IF to_regclass('public.partner_locations') IS NULL THEN
    RAISE EXCEPTION '0103 requires partner_locations';
  END IF;
  IF NOT EXISTS (
...
DO $$ BEGIN
  IF to_regclass('public.partner_google_connections') IS NULL
    ...
    RAISE EXCEPTION '0103 Google presence schema is incomplete';
  END IF;
END$$;

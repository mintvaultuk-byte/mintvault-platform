...
// V850/SilverFast TIFF masters can be about 97 MiB at 1200 DPI. Decoder pixel
// limits and byte signatures are enforced again at the evidence boundary.
export const scanUpload = multer({
  storage: multer.memoryStorage(),
  limits: { fileSize: 128 * 1024 * 1024, files: 2 },
});

export const certImgUpload = multer({
  storage: multer.memoryStorage(),

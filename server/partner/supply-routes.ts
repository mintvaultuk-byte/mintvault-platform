...
export function partnerSupplyRouter(): Router {
  ...
  // Reception holds legacy orders.submit, so it is intentionally insufficient here. A Finance Viewer has partner.orders.view but deliberately lacks credits.purchase. The two

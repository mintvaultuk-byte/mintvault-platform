...
export function cardPdf(masterPng: Buffer, lock: TemplateLock): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    const W = cw * MM_TO_PT, H = ch * MM_TO_PT;
    ...
    const marks: [number, number, number, number][] = [
      [t.x, 0, t.x, markLen], [0, t.y, markLen, t.y], // top-left
      [t.x + t.w, 0, t.x + t.w, markLen], [W, t.y, W - markLen, t.y], // top-right
      [t.x, H, t.x, H - markLen], [0, t.y + t.h, markLen, t.y + t.h], // bottom-left
      [t.x + t.w, H, t.x + t.w, H - markLen], [W, t.y + t.h, W - markLen, t.y + t.h], // bottom-right
    ];

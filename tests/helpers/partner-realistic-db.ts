 ...
 *
 * 0050 grants partner_connector_runtime the RLS-scoped SELECT on partner_profiles(tenant_id,
 ...
 * connector import already uses this list, and without 0050 that import fails 42501 — which is

...
- Keep Google behind its own flag/config/schema gate and persist OAuth state, connection identity, encrypted credential and public cache separately in prepared migration 0101.

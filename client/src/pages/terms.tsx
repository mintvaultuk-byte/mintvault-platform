...
export default function TermsPage() {
  return (
    <div className="px-4 py-10 max-w-3xl mx-auto">
      <Link href="/">
        <button className="flex items-center gap-1.5 text-[#FFCB05]/60 hover:text-[#FFCB05] transition-colors mb-8" data-testid="button-back-home">
          <ArrowLeft size={16} /> Back to Home
        </button>
      </Link>

      <h1 className="text-3xl font-bold text-[#FFCB05] tracking-widest mb-2 glow-gold text-center" data-testid="text-terms-title">
        TERMS & CONDITIONS
      </h1>
      ...
      <div className="space-y-8 text-[#444444] text-sm leading-relaxed">
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">1. Service Overview</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">2. Submissions</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">3. Grading & Assessment</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">4. Turnaround Times</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">5. Payment</h2>
          <p>
        ...
        <section id="liability" data-testid="section-liability">
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">6. Liability & Shipping Policy</h2>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Delivered to MintVault's registered address</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Signed for and logged into our intake system</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Secure packaging</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Fully tracked delivery</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Insurance coverage appropriate to the declared value</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Must reflect fair market value at time of submission</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Determines return shipping insurance</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Sets maximum liability cap during custody</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>The declared value submitted</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>OR Verified fair market value at time of loss</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Fully tracked delivery</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Insurance up to declared value</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Signature confirmation where applicable</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4 mb-3">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Market fluctuations</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Grading outcome disputes</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Minor cosmetic slab/label variations</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Courier delays</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Events beyond reasonable control</span></li>
          </ul>
          ...
          <ul className="space-y-1 ml-4">
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Require additional insurance</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Apply insurance surcharges</span></li>
            <li className="flex items-start gap-2"><span className="text-[#FFCB05]">•</span><span>Decline items exceeding declared value thresholds</span></li>
          </ul>
        </section>

        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">7. Cancellations & Refunds</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">8. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">9. Force Majeure</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">10. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">11. Contact</h2>
          <p>
            For questions regarding these terms, please contact us at{" "}
            <a href="mailto:mintvaultuk@gmail.com" className="text-[#FFCB05] underline" data-testid="link-email-terms">

    ...
    <>
      ...
      <div className="max-w-[720px] mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-2 mb-8">
          <span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[#FFCB05]/10 text-[#FFCB05] border border-[#FFCB05]/30">
        ...
        <article className="prose prose-sm max-w-none
          ...
          prose-a:text-[#FFCB05] prose-a:underline hover:prose-a:text-[#FFCB05]
          prose-blockquote:border-l-[#FFCB05] prose-blockquote:text-[#666666] prose-blockquote:bg-[#FAFAF8] prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r

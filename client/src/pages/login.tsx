    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-md rounded-2xl overflow-hidden shadow-xl bg-[#0A0A0A] p-8 md:p-10">
        ...
        <div className="space-y-2 text-center">
          <Link href="/signup" className="block text-xs text-[#888888] hover:text-[#FFCB05] transition-colors">
            New here? Create your account →
          </Link>
          <Link href="/forgot-password" className="block text-xs text-[#888888] hover:text-[#FFCB05] transition-colors">

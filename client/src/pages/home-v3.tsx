...
/* =========================================================================
   ...
   Only changes:
   1. Hero slab fan upgraded to real CSS 3D with active idle drift + scroll rotation
   2. Subtle ambient gold warmth drifting across cream sections
   3. Subtle ambient gold breathing behind dark sections
   ========================================================================= */
...
/* =========================================================================
   PAGE
   ========================================================================= */
export default function MintVaultHomeV3() {
  return (
    <div style={{
      backgroundColor: V.paper,
      color: V.ink,

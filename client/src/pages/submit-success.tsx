  ...
  if (!submission) {
    return (
      <div className="px-4 py-12 text-center">
        ...
        <Link href="/submit">
          <button
            className="border border-[#D4AF37] bg-white text-[#D4AF37] px-6 py-2.5 rounded font-medium transition-all hover:bg-[#D4AF37]/10"
  ...
  return (
    <div className="px-4 py-12 max-w-xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h1
          className="text-2xl md:text-3xl font-bold text-[#D4AF37] tracking-wide mb-2"
      ...
      <div className="border border-[#D4AF37]/30 rounded-lg overflow-hidden mb-6">
        <div className="bg-[#D4AF37]/5 p-4 border-b border-[#D4AF37]/20 flex items-center gap-2">
          ...
          <h2 className="text-[#D4AF37] font-semibold tracking-wider text-sm uppercase">Submission Confirmation</h2>
        </div>
      ...
      <div className="border border-emerald-300 rounded-lg p-5 mb-6 bg-emerald-50">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-emerald-600 font-semibold tracking-wider text-sm uppercase">Packing Slip</h3>
        </div>
        <p className="text-[#555555] text-sm mb-4">
          Download your packing slip and include it inside your package. This is essential for us to process your
          submission quickly.
        </p>
        <a
      ...
      <div className="border border-[#D4AF37]/20 rounded-lg p-5 mb-8">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-[#D4AF37] font-semibold tracking-wider text-sm uppercase">Shipping Instructions</h3>
        </div>

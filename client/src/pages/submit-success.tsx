...
export default function SubmitSuccessPage() {
    ...
    return (
      <div className="px-4 py-12 text-center">
        <div className="animate-pulse space-y-4">
          <div className="h-12 bg-[#FFCB05]/10 rounded w-12 mx-auto rounded-full" />
          <div className="h-6 bg-[#FFCB05]/10 rounded w-48 mx-auto" />
  ...
  if (!submission) {
    return (
      <div className="px-4 py-12 text-center">
        <h2 className="text-2xl font-bold text-[#FFCB05] mb-4" data-testid="text-not-found">
          Submission Not Found
        </h2>
        <Link href="/submit">
          <button className="border border-[#FFCB05] bg-white text-[#FFCB05] px-6 py-2.5 rounded font-medium transition-all hover:bg-[#FFCB05]/10" data-testid="button-new-submission">
  ...
  return (
    <div className="px-4 py-12 max-w-xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-[#FFCB05] tracking-wide mb-2" data-testid="text-success-title">
          Submission Received!
        </h1>
      ...
      <div className="border border-[#FFCB05]/30 rounded-lg overflow-hidden mb-6">
        <div className="bg-[#FFCB05]/5 p-4 border-b border-[#FFCB05]/20 flex items-center gap-2">
          <FileText size={18} className="text-[#FFCB05]" />
          <h2 className="text-[#FFCB05] font-semibold tracking-wider text-sm uppercase">
      ...
      <div className="border border-[#FFCB05]/30 rounded-lg p-5 mb-6 bg-[#FFCB05]/5">
        <div className="flex items-center gap-2 mb-3">
          <Download size={18} className="text-[#FFCB05]" />
          <h3 className="text-[#FFCB05] font-semibold tracking-wider text-sm uppercase">
            Shipping Label
          </h3>
        </div>
        <p className="text-[#555555] text-sm mb-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border border-[#FFCB05] bg-[#FFCB05]/10 text-[#FFCB05] px-5 py-2.5 rounded font-medium tracking-wide text-sm transition-all hover:bg-[#FFCB05]/20"
      ...
      <div className="border border-[#FFCB05]/20 rounded-lg p-5 mb-8">
        <div className="flex items-center gap-2 mb-3">
          <Package size={18} className="text-[#FFCB05]" />
          <h3 className="text-[#FFCB05] font-semibold tracking-wider text-sm uppercase">
        ...
        <div className="text-[#555555] text-sm space-y-3">
          <div className="space-y-1.5">
            ...
            <ol className="list-decimal list-inside text-[#555555] text-xs space-y-1">
              ...
              <li>Write your Submission ID (<span className="text-[#FFCB05] font-mono font-bold">{subId}</span>) on the outside of the box</li>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link href="/submit" className="flex-1">
          <button className="w-full border border-[#FFCB05] bg-white text-[#FFCB05] py-2.5 rounded font-medium tracking-wide transition-all hover:bg-[#FFCB05]/10" data-testid="button-another-submission">
            Submit Another Order
          </button>
        </Link>
        <Link href="/" className="flex-1">
          <button className="w-full border border-[#FFCB05]/30 text-[#FFCB05]/60 py-2.5 rounded font-medium transition-all hover:border-[#FFCB05]/50 hover:text-[#FFCB05]" data-testid="button-back-home">
            Back to Home
          </button>
        </Link>
      </div>
...
function ConfirmRow({ label, value, testId, highlight }: { label: string; value: string; testId: string; highlight?: boolean }) {
  return (
    <div className="flex justify-between items-center border-b border-[#FFCB05]/10 pb-2 last:border-0">
      <span className="text-[#FFCB05]/60 text-sm">{label}</span>
      <span className={`font-medium text-sm ${highlight ? "text-[#FFCB05] font-mono font-bold" : "text-[#1A1A1A]"}`} data-testid={testId}>
        {value}
      </span>
    </div>
  );

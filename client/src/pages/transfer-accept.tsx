...
export default function TransferAcceptPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setPageState({
        type: "success",
        message: data.message || "Transfer verified. A 14-day dispute window is now active.",
      });
    } catch (err: any) {
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-sans font-bold text-[#1A1A1A] tracking-tight">Accept Keepership Transfer</h1>
          <p className="text-[#666666] mt-2">Verify the Document Reference Number to accept this transfer</p>
        </div>
            ...
            <CardContent className="flex items-start gap-3 pt-5 pb-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#999999] mt-3">
                  Both parties will be emailed when the transfer is finalised. If either party raises a dispute within
                  14 days, the transfer will be paused for review.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div>
                ...
                {!pageState.retryable && (
                  <p className="text-xs text-[#999999] mt-2">
                    ...
                    <a href="mailto:support@mintvaultuk.com" className="text-[#D4AF37] hover:underline">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="refNumber" className="text-[#444444]">
                  ...
                  <p className="text-xs text-[#999999]">
                    This 12-character code is on the Logbook document that came with the card. The seller should have
                    provided it to you.
                  </p>
                </div>
              ...
              <div className="mt-6 pt-5 border-t border-[#E8E4DC]">
                ...
                <p className="text-xs text-[#999999] mt-3">
                  Don't have the reference number? Ask the seller to provide the Logbook that accompanied the graded
                  card.
                </p>
              </div>
            </CardContent>

  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 no-text-shadow">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white tracking-wide mb-2" data-testid="text-h1-pokemon-grading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            {[
              ...
              <div key={i} className="border border-[#E3350D]/20 rounded-lg p-5 text-center" data-testid={`card-process-${i}`}>
                ...
                <p className="text-[#d4d4d4] text-sm leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        ...
        <section className="max-w-3xl mx-auto border border-[#E3350D]/30 rounded-lg p-6 md:p-8 bg-[#E3350D]/5 text-center" data-testid="section-cta">
          ...
          <p className="text-[#d4d4d4] text-sm mb-6 max-w-lg mx-auto">Professional UK-based grading with fast turnaround and insured return shipping.</p>

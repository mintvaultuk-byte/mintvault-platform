...
function SpecCard({ icon, specs, onDark }: { icon: JSX.Element; specs: string[]; onDark: boolean }) {
  return (
    <div
      className="rounded-xl p-8"
      style={{
        backgroundColor: onDark ? "rgba(255,255,255,0.03)" : "var(--v2-paper-raised)",
        border: onDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid var(--v2-line)",
      }}
    >
      <div
        className="w-14 h-14 rounded-xl flex items-center justify-center"
        style={{
          backgroundColor: onDark ? "rgba(212,175,55,0.1)" : "rgba(212,175,55,0.08)",
          color: "var(--v2-gold)",
        }}
      >
        {icon}
      ...
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-10 md:gap-16 items-start">
          ...
          <div>
            ...
            <p className="font-body text-base md:text-lg leading-relaxed mt-6 max-w-md" style={{ color: bodyColour }}>
              {body}
            </p>
          </div>
          {/* Right: spec card */}
  ...
  return (
    <div className="min-h-screen flex flex-col vault-page">
      ...
      <section className="frost-paper">
        <div className="mx-auto max-w-7xl px-6 pt-12 md:pt-20 pb-16 md:pb-24 grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            >
              Every MintVault slab is built around five purpose-designed components. NFC tap-to-verify, sonic weld seal,
              optical-grade acrylic, QR cert lookup, and a zero-movement cradle. Each is engineered to protect, verify,
              and display a graded card for decades.
            </p>
            <p
      ...
      <ComponentSection
        ...
        icon={<Nfc size={48} />}
        specs={["NTAG213 or NTAG215 chip", "Read range 1–3cm", "Passive — no battery", "Hand-tested pre-seal"]}
        onDark={true}
        bgVar="var(--v2-panel-dark)"
      />
      ...
      <ComponentSection
        ...
        icon={<Lock size={48} />}
        specs={["20kHz ultrasonic weld", "Tamper-evident seam", "Hand-inspected post-seal", "Tolerance ±0.1mm"]}
        onDark={false}
        bgVar="var(--v2-paper)"
      />
      ...
      <ComponentSection
        ...
        icon={<Gem size={48} />}
        specs={["Optical-grade acrylic", "UV-stabilised", "Scratch-resistant surface", "2.5mm wall thickness"]}
        onDark={false}
        bgVar="var(--v2-paper-raised)"
      />
      ...
      <ComponentSection
        ...
        icon={<QrCode size={48} />}
        specs={["Unique per cert", "Opens /vault/MV[id]", "No app required", "Printed with the label"]}
        onDark={true}
        bgVar="var(--v2-panel-dark)"
      />
      ...
      <ComponentSection
        ...
        icon={<Layers size={48} />}
        specs={["Four card-thickness profiles", "Zero-contact mounting", "Archival-grade material", "Cut to ±0.05mm"]}
        onDark={false}
        bgVar="var(--v2-paper)"
      />
      ...
      <section className="frost-panel-dark">
        <div className="mx-auto max-w-3xl px-6 py-20 md:py-28 text-center">
          ...
          <p className="font-body text-sm md:text-base mb-10" style={{ color: "#ffffff" }}>
            Every MintVault submission ships in a slab with all five components. No tiers, no upgrades, no premium
            shells. One standard.
          </p>

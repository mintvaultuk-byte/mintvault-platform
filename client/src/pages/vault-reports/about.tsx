...
const FEATURES = [
  ...
  {
    icon: <Shield size={20} className="text-[#FFCB05]" />,
  ...
  {
    icon: <Users size={20} className="text-[#FFCB05]" />,
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24 space-y-16">
        ...
        {/* What is */}
        <section>
          <p className="text-[#FFCB05] text-xs font-bold uppercase tracking-[0.2em] mb-4">What is a Vault?</p>
        ...
        {/* What's included */}
        <section>
          <p className="text-[#FFCB05] text-xs font-bold uppercase tracking-[0.2em] mb-6">What's Included</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {FEATURES.map(({ icon, title, desc }) => (
              <div key={title} className="p-5 rounded-2xl bg-white border border-[#E8E4DC]">
                <div className="w-10 h-10 rounded-xl bg-[#FFF9E6] border border-[#FFCB05]/20 flex items-center justify-center mb-4">
                  {icon}
                </div>
        ...
        {/* Why it matters */}
        <section className="p-6 rounded-2xl border-l-4 bg-[#FAFAF8] border border-[#E8E4DC]" style={{ borderLeftColor: "#FFCB05" }}>
          <p className="text-[#FFCB05] text-xs font-bold uppercase tracking-[0.2em] mb-4">Why It Matters</p>
        ...
        <section className="text-center space-y-4">
          ...
          <p className="text-[#AAAAAA] text-xs">Then <Link href="/vault-reports/how-to-read" className="text-[#FFCB05] hover:underline">learn how to read one →</Link></p>
        </section>
      </div>
    </>
  );

...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErrorMessage("Couldn't send your message. Please email hello@mintvaultuk.com directly or try again.");
            ...
            {submitted ? (
              <div className="p-8 rounded-2xl bg-[#FFF9E6] border border-[#D4AF37]/30 text-center space-y-3">
                ...
                <p className="text-[#666666] text-sm">
                  Thanks for getting in touch. We'll get back to you within 24 hours during business days.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@mintvaultuk.com"
                      className="text-sm text-[#1A1A1A] font-medium hover:text-[#B8960C] transition-colors"
                    >
              ...
              <div className="space-y-3">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="text-[#888] group-hover:text-[#B8960C] transition-colors"
                  >

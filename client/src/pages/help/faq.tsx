...
const FAQ_DATA: FAQGroup[] = [
  {
    ...
    items: [
      ...
      { q: "What's the turnaround time?", a: <>Turnaround times are measured from the day we receive your cards. See <a href="/pricing" className="underline">current grading prices and turnaround</a> for available services. Pristine 10P is a free automatic upgrade when every subgrade scores a 10 — no separate tier or fee.</> },
      { q: "How much does grading cost?", a: <>See <a href="/pricing" className="underline">current grading prices</a>, available services and bulk discount guidance. Your submission quote confirms the total before payment.</> },

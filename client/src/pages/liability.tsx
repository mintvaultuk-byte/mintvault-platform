  ...
  return (
    <div className="px-4 py-10 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-center gap-3 mb-2">
        <Shield size={28} className="text-[#FFCB05]" />
        <h1 className="text-3xl font-bold text-[#FFCB05] tracking-widest glow-gold" data-testid="text-liability-title">
          LIABILITY & INSURANCE
        </h1>
      </div>
      ...
      <div className="space-y-8 text-[#444444] text-sm leading-relaxed">
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">1. Incoming Shipping</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">2. Custody Period</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">3. Market Value Determination</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">4. Return Shipping</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">5. Exclusions</h2>
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">6. Claims Process</h2>
          <p>
            ...
            <a href="mailto:info@mintvault.co.uk" className="text-[#FFCB05] underline" data-testid="link-email-claims">
        ...
        <section>
          <h2 className="text-[#FFCB05] font-bold tracking-wider text-lg mb-3">7. General</h2>
          <p>
            This policy should be read in conjunction with our{" "}
            <Link href="/terms-and-conditions">
              <span className="text-[#FFCB05] underline cursor-pointer" data-testid="link-terms">Terms & Conditions</span>
            </Link>.

...
export default function AdminPricing() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#FFCB05] tracking-widest" data-testid="text-pricing-title">
          PRICING MANAGEMENT
        </h1>
      ...
      {isLoading ? (
        <div className="animate-pulse space-y-3">
          {[1, 2, 3].map(i => <div key={i} className="h-16 bg-[#FFCB05]/5 rounded" />)}
        </div>
      ) : tiers.length === 0 ? (
        <div className="text-center py-12 border border-[#FFCB05]/10 rounded-lg">
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={`border rounded-lg p-4 transition-colors ${
                !tier.is_active ? "border-[#E8E4DC] opacity-60" : "border-[#FFCB05]/20"
              }`}
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border border-[#FFCB05]/30 rounded px-3 py-2 text-[#1A1A1A] text-sm focus:outline-none focus:border-[#FFCB05]"
                  ...
                  <div className="flex gap-2 pt-1">
                    <button
                      ...
                      className="border border-[#FFCB05] bg-[#FFCB05]/10 text-[#FFCB05] px-4 py-2 rounded font-medium text-sm transition-all hover:bg-[#FFCB05]/20 disabled:opacity-50 flex items-center gap-1.5"
                    ...
                    <button
                      ...
                      className="text-[#666666] hover:text-[#1A1A1A] text-sm px-4 py-2 rounded border border-[#E8E4DC] hover:border-[#FFCB05]/40 transition-colors"
      ...
      <div className="mt-6 border border-[#FFCB05]/10 rounded-lg p-4">

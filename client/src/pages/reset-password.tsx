...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4 py-16">
      <SeoHead
        title="Reset Password | MintVault UK"
        description="Choose a new password for your MintVault account."
        canonical="https://mintvaultuk.com/reset-password"
      />
        ...
        {done ? (
          ...
          <>
            ...
            <p className="text-xs text-center text-[#888888] mt-6">
              <Link href="/forgot-password" className="text-[#B8960C] font-semibold hover:text-[#D4AF37]">
                Request a new link
              </Link>
            </p>
          </>

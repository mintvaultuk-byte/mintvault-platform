...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4 py-16">
      <SeoHead
        title="Forgot Password | MintVault UK"
        description="Reset your MintVault account password."
        canonical="https://mintvaultuk.com/forgot-password"
      />
        ...
        {done ? (
          <div className="text-center">
            ...
            <p className="text-sm text-[#666666] mb-6">
              If an account exists for <strong>{email}</strong>, a password reset link has been sent. Check your spam
              folder if you don't see it within a minute.
            </p>
            <Link href="/login" className="text-sm text-[#B8960C] font-semibold hover:text-[#D4AF37] transition-colors">
              ← Back to sign in
            </Link>
          </div>
        ) : (

    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4 mb-10">
          ...
          {/* Register Ownership */}
          <Link href="/claim">
            <div className="group relative z-[3] border border-[#FFCB05]/25 bg-[#FAFAF8] rounded-2xl p-7 cursor-pointer hover:border-[#FFCB05]/60 hover:bg-white transition-all duration-200">
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-1">
                    ...
                    <ChevronRight className="w-5 h-5 text-[#FFCB05]/50 group-hover:text-[#FFCB05] transition-colors flex-shrink-0" />
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-[#FFCB05]/50 bg-[#FAFAF8] rounded-full px-3 py-1">
          ...
          {/* Transfer Ownership */}
          <Link href="/transfer">
            <div className="group relative z-[3] border border-[#E8E4DC] bg-white rounded-2xl p-7 cursor-pointer hover:border-[#FFCB05]/40 hover:bg-[#FAFAF8] transition-all duration-200">
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 border border-[#FFCB05]/30 bg-[#FAFAF8]">
                  <ArrowRightLeft className="w-6 h-6 text-[#FFCB05]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-1">
                    <h2 className="text-lg font-bold text-[#1A1A1A] uppercase tracking-wide">Transfer Ownership</h2>
                    <ChevronRight className="w-5 h-5 text-[#FFCB05]/30 group-hover:text-[#FFCB05]/70 transition-colors flex-shrink-0" />
                  </div>
                  <p className="text-[#666666] text-sm leading-relaxed mb-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-[#FFCB05]/40 bg-white rounded-full px-3 py-1">
        ...
        <div className="relative z-[3] border border-[#E8E4DC] rounded-2xl p-6 bg-[#FAFAF8]">
          <div className="flex items-start gap-3 mb-4">
            <BookOpen className="w-5 h-5 text-[#FFCB05]/60 flex-shrink-0 mt-0.5" />
            <h3 className="text-sm font-bold text-[#FFCB05]/80 uppercase tracking-widest">About Ownership</h3>
          </div>
          <div className="space-y-3 text-xs text-[#999999] leading-relaxed">
            ...
            <p>
              ...
              <Link href="/verify" className="text-[#FFCB05] hover:underline">Certificate Lookup</Link>.
            </p>
          </div>
        </div>

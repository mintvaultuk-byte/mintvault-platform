  ...
  return (
    <div className="min-h-[60vh] bg-[#FAFAF8] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm bg-white rounded-2xl border border-[#D4AF37]/30 shadow-lg p-8 text-center">
        ...
        <h2 className="text-xl font-black text-[#1A1A1A] mb-2">Sign in to continue</h2>
        <p className="text-sm text-[#888888] mb-7">You need to be logged in to view this page.</p>
        <div className="flex flex-col gap-3">
          <Link href={`/login${next}`}>
            <GradientButton className="gradient-btn-filled w-full">Log In</GradientButton>
          </Link>

...
export default function ManualCentering({
  certId,
  side,
  imageUrl,
  onSave,
  ...
  const result = computeCentering(outer, inner, side);
    ...
    return (
      <>
        ...
        <rect
          ...
          stroke={color}
          strokeWidth="0.15"
          strokeDasharray={dashed ? "0.6,0.4" : "none"}
          opacity="0.9"
        />
        ...
        <div className="relative w-full h-full max-w-[85vh] overflow-hidden rounded-lg bg-[var(--admin-bg2)]">
          ...
          >
            ...
            >
              ...
              <line
                x1={outer.left}
                y1={(inner.top + inner.bottom) / 2}
                x2={inner.left}
                y2={(inner.top + inner.bottom) / 2}
                stroke="#D4AF37"
                strokeWidth="0.15"
                opacity="0.5"
              />
              ...
              />
              <line
                x1={(inner.left + inner.right) / 2}
                y1={outer.top}
                x2={(inner.left + inner.right) / 2}
                y2={inner.top}
                stroke="#D4AF37"
                strokeWidth="0.15"
                opacity="0.5"

...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/partner/customers", label: "Customers", icon: Users, permission: "partner.customers.view" },
  { href: "/partner/grading", label: "Grading", icon: LayoutDashboard, permission: "partner.cards.assess" },

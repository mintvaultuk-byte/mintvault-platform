...
export default function SlabShowcase({ items, className }: Props) {
  ...
  return (
    <>
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        fontSize:
                          (item.grade % 1 !== 0 ? Math.round(13 * pos.scale) : Math.round(16 * pos.scale)) + "px",
                        fontWeight: 800,
                        lineHeight: 1,
      ...
      {/* Cert overlay — portalled to document.body so it can never stack
          beneath the hero copy or any other page layer */}

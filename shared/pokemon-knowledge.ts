...
export const LANGUAGE_GUIDE: readonly LanguageGuideEntry[] = [
  ...
  { key: "fr", label: "French", pickerValue: "fr", region: "western", sampleScript: "Pikachu — Pokémon de base", setCodeFormat: "Same codes as English (EB/…) with French text", rarityFormat: "Same symbol system as English", tips: ["'Illus.' and French card text; same set structure as EN."], commonMistakes: ["Do not file French cards as Other; French has a canonical picker value."] },
  { key: "de", label: "German", pickerValue: "de", region: "western", sampleScript: "Pikachu — Basis-Pokémon", setCodeFormat: "Same as English structure", rarityFormat: "Same symbol system", tips: ["German card text."], commonMistakes: ["Do not file German cards as Other; German has a canonical picker value."] },
  { key: "it", label: "Italian", pickerValue: "it", region: "western", sampleScript: "Pikachu — Pokémon Base", setCodeFormat: "Same as English structure", rarityFormat: "Same symbol system", tips: ["Italian card text."], commonMistakes: ["Do not file Italian cards as Other; Italian has a canonical picker value."] },
  { key: "es", label: "Spanish", pickerValue: "es", region: "western", sampleScript: "Pikachu — Pokémon Básico", setCodeFormat: "Same as English structure", rarityFormat: "Same symbol system", tips: ["Spanish card text; LATAM + ES releases."], commonMistakes: ["Do not file Spanish cards as Other; Spanish has a canonical picker value."] },
  { key: "pt", label: "Portuguese", pickerValue: "pt", region: "western", sampleScript: "Pikachu — Pokémon Básico (PT)", setCodeFormat: "Same as English structure", rarityFormat: "Same symbol system", tips: ["Brazilian releases most common."], commonMistakes: ["Do not file Portuguese cards as Other; Portuguese has a canonical picker value."] },

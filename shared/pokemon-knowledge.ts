...
export const LANGUAGE_GUIDE: readonly LanguageGuideEntry[] = [
  ...
  { key: "zh-Hans", label: "Simplified Chinese", pickerValue: "zh-Hans", region: "china", sampleScript: "皮卡丘 — 基础宝可梦", setCodeFormat: "CS/CSM-style codes; mainland-exclusive sets exist", rarityFormat: "Letter codes incl. exclusive tiers (e.g. MA)", tips: ["Simplified characters (宝可梦)."], commonMistakes: ["Merging mainland-exclusive sets with international ones — they are separate products."] },
  { key: "zh-Hant", label: "Traditional Chinese", pickerValue: "zh-Hant", region: "china", sampleScript: "皮卡丘 — 基礎寶可夢", setCodeFormat: "Follows JP-style codes for TW/HK releases", rarityFormat: "Japanese-style letter codes", tips: ["Traditional characters (寶可夢)."], commonMistakes: ["Confusing with Simplified Chinese releases — different products."] },
